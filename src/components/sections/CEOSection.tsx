          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 z-20 bg-gradient-to-t from-primary-dark via-primary-dark/50 to-transparent">
                 <h3 className="text-3xl font-black text-white">Mr. Muzaffar Ali</h3>
                 <p className="text-accent font-black uppercase tracking-widest text-xs">Founder & CEO</p>
              </div>
            </motion.div>
            ...
            <div className="lg:col-span-3">
              ...
              >
                ...
                <h4 className="text-white/40 text-xs font-black uppercase tracking-widest mb-6">A Message From Our Leader</h4>
                <h2 className="text-4xl md:text-5xl font-black text-white mb-10 tracking-tighter leading-tight italic">
                  "Secure Watch 24 Services is committed to delivering reliable security monitoring solutions that help businesses and individuals <span className="text-gradient">stay protected 24/7</span>."
                </h2>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-8 pt-8 border-t border-white/5">
                   ...
                   <div className="text-center sm:text-left">
                      <p className="text-white font-black text-lg">Integrity. Vigilance. Trust.</p>
                      <p className="text-white/30 text-xs uppercase tracking-widest font-bold">Core Leadership Principles</p>
                   </div>
                </div>
              </motion.div>
            </div>
